namespace BaristaLabs.ChromeDevTools.Runtime
{
    ...
    public partial class ChromeSession : IDisposable
    {
            ...
            where TCommand : ICommand
        {
            ...
            var result = await SendCommand(command.CommandName, JToken.FromObject(command), cancellationToken, throwExceptionIfResponseNotReceived);
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public async Task<JToken> SendCommand(string commandName, JToken @params, CancellationToken cancellationToken, bool throwExceptionIfResponseNotReceived = true)
        {
            var message = new
            {
